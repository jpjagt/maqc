    ...
    for i in range(1, 5): # 5 sensors
        ...
        for cs_df in [cs_1min, cs_5min, cs_10min, cs_30min, cs_60min]: # 5 aggregation intervals
            ...
            for j in range (0, 100):
                # Models with no hyperparam tuning (GLM, GAM, ANN)
                if plt_id == 0:        # PM2.5
                    xtrain, xtest, ytrain, ytest = train_test_split(
                        xtraintest[['log_PM25','tmpf','dwpf','relh','mslp']],
                        ytraintest, test_size = 0.2)
                elif plt_id == 1:      # NO2
                    xtrain, xtest, ytrain, ytest = train_test_split(
                        xtraintest[['gas_op2_w','tmpf','dwpf','relh','mslp']],
                        ytraintest, test_size = 0.2)    
                ...
                #     best_ann = cs_ann                  
            # Output best model
            # joblib.dump(best_lr,'D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Models//lr_cs0'+str(i+1)+'_intv0'+str(intv+1)+'_plt'+str(plt_id))
            # joblib.dump(best_elnet,'D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Models//elnet_cs0'+str(i+1)+'_intv0'+str(intv+1)+'_plt'+str(plt_id))
            # joblib.dump(best_gam,'D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Models//gam_cs0'+str(i+1)+'_intv0'+str(intv+1)+'_plt'+str(plt_id))
            # joblib.dump(best_svr,'D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Models//svr_cs0'+str(i+1)+'_intv0'+str(intv+1)+'_plt'+str(plt_id))
            # joblib.dump(best_rf,'D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Models//rf_cs0'+str(i+1)+'_intv0'+str(intv+1)+'_plt'+str(plt_id))
            joblib.dump(best_gbt,'D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Models//gbt_cs0'+str(i+1)+'_intv0'+str(intv+1)+'_plt'+str(plt_id))
            # best_ann.save('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Models//ann_cs0'+str(i+1)+'_intv0'+str(intv+1)+'_plt'+str(plt_id)+'.h5')
            intv += 1            
        ...
        # lr_r2df.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//lr_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rsquared.csv')
        # lr_rmsedf.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//lr_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rmse.csv')
        ...
        # elnet_r2df.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//elnet_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rsquared.csv')
        # elnet_rmsedf.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//elnet_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rmse.csv')
        ...
        # gam_r2df.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//gam_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rsquared.csv')
        # gam_rmsedf.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//gam_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rmse.csv')
        ...
        # svr_r2df.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//svr_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rsquared.csv')
        # svr_rmsedf.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//svr_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rmse.csv')
        ...
        # rf_r2df.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//rf_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rsquared.csv')
        # rf_rmsedf.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//rf_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rmse.csv')
        ...
        gbt_r2df.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//gbt_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rsquared.csv')
        gbt_rmsedf.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//gbt_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rmse.csv')
        ...
        # ann_r2df.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//ann_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rsquared.csv')
        # ann_rmsedf.to_csv('D://MIT Research Docs//CityScannerCalibration_2108//AirQualityData//NYC_Calibration_2109//Master_Calib_Perfs//ann_cs0'+str(i+1)+'_plt'+str(plt_id)+'_rmse.csv')        
